...
class DuckDBStore:
    ...
    def update_message_analysis(
        ...
        # Use INSERT OR REPLACE to atomically upsert (workaround for DuckDB
        # ART index bug where DELETE + INSERT in the same transaction still
        # raises a spurious duplicate-key error).
        self.conn.execute("""
